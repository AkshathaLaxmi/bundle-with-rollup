...
exports.handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var user, userInfo, tableName, result, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                user = (_a = event === null || event === void 0 ? void 0 : event.arguments) === null || _a === void 0 ? void 0 : _a.input;
                user.id = crypto.randomUUID();
                userInfo = lodashExports.pick(user, ["id", "email"]);
                tableName = process.env.USER_TABLE || "";
                return [4 /*yield*/, putItem(tableName, userInfo)];
            case 1:
                result = _b.sent();
                return [2 /*return*/, {
                        statusCode: 200,
