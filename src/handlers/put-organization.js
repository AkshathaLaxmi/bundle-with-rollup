...
exports.handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var organization, tableName, result, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                organization = (_a = event === null || event === void 0 ? void 0 : event.arguments) === null || _a === void 0 ? void 0 : _a.input;
                organization.id = crypto.randomUUID();
                tableName = process.env.ORGANIZATION_TABLE || "";
                return [4 /*yield*/, putItem(tableName, organization)];
            case 1:
                result = _b.sent();
                return [2 /*return*/, {
                        statusCode: 200,
